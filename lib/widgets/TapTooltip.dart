...
/// other user interface action. Wrap the button in a [TapTooltip] widget to
...
/// widget to include a [TapTooltip] in its build.
///
...
class TapTooltip extends StatefulWidget {
  ...
  /// [TapTooltip.message]. Set this property to true if the app is going to
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(FlagProperty('semantics',
        value: excludeFromSemantics, ifTrue: 'excluded', showName: true, defaultValue: null));
    properties
...
class _TapTooltipState extends State<TapTooltip> with SingleTickerProviderStateMixin {
