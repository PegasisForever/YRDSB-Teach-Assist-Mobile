...
import 'package:ta/prasers/JSONCourseListParserV8.dart';
...
AssignmentAdded _parseAssignmentAdded(Map<String, dynamic> json) {
  ...
  assignmentAdded.assignment = parseAssignment(json["assignment"]);
...
AssignmentUpdated _parseAssignmentUpdated(Map<String, dynamic> json) {
  ...
  assignmentUpdated.assignmentBefore = parseAssignment(json["assignment_before"]);
  assignmentUpdated.assignmentAvgBefore = json["assignment_avg_before"];
  assignmentUpdated.overallBefore = json["overall_before"];
  assignmentUpdated.assignmentAfter = parseAssignment(json["assignment_after"]);
  assignmentUpdated.assignmentAvgAfter = json["assignment_avg_after"];
  assignmentUpdated.overallAfter = json["overall_after"];
